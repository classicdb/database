-- Inserting winter hats into creature_loot_table

INSERT INTO `creature_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `groupid`, `mincountOrRef`, `maxcount`, `condition_id`) VALUES (9237, 21524, 100, 2, 1, 1, 32);
INSERT INTO `creature_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `groupid`, `mincountOrRef`, `maxcount`, `condition_id`) VALUES (10997, 21524, 100, 2, 1, 1, 32);
INSERT INTO `creature_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `groupid`, `mincountOrRef`, `maxcount`, `condition_id`) VALUES (9019, 21524, 100, 2, 1, 1, 32);
INSERT INTO `creature_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `groupid`, `mincountOrRef`, `maxcount`, `condition_id`) VALUES (10899, 21525, 100, 2, 1, 1, 32);
INSERT INTO `creature_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `groupid`, `mincountOrRef`, `maxcount`, `condition_id`) VALUES (11486, 21525, 100, 2, 1, 1, 32);
UPDATE `creature_loot_template` SET `ChanceOrQuestChance`=100 AND `groupid`=3 WHERE `entry`=1853;

-- Inserting model changes into christmas outfits
INSERT INTO `game_event_creature_data` (`guid`, `entry_id`, `modelid`, `equipment_id`, `spell_start`, `spell_end`, `event`) VALUES (45840, 9237, 15737, 0, 0, 0, 2);
INSERT INTO `game_event_creature_data` (`guid`, `entry_id`, `modelid`, `equipment_id`, `spell_start`, `spell_end`, `event`) VALUES (54433, 10997, 15733, 0, 0, 0, 2);
INSERT INTO `game_event_creature_data` (`guid`, `entry_id`, `modelid`, `equipment_id`, `spell_start`, `spell_end`, `event`) VALUES (47613, 9019, 15735, 0, 0, 0, 2);
INSERT INTO `game_event_creature_data` (`guid`, `entry_id`, `modelid`, `equipment_id`, `spell_start`, `spell_end`, `event`) VALUES (40458, 10899, 15760, 0, 0, 0, 2);
INSERT INTO `game_event_creature_data` (`guid`, `entry_id`, `modelid`, `equipment_id`, `spell_start`, `spell_end`, `event`) VALUES (137881, 11486, 15734, 0, 0, 0, 2);

-- Updating position of Goli Krumm

UPDATE `creature` SET `position_x`=-4882.85, `position_y`=953.062, `position_z`=501.464, `orientation`=3.566
WHERE `guid`=86181;
...
INSERT INTO `game_event` (`entry`, `start_time`, `end_time`, `occurence`, `length`, `holiday`, `description`) VALUES (52, '2006-12-25 16:00:00', '2020-12-31 16:00:00', 525600, 11700, 0, 'Winter Veil: Gifts');

-- Moving quests Winter Presents and New Year Celebrations to 
-- their respective holidays

UPDATE `game_event_quest` SET `event`= 52 WHERE `quest`= 8827;
UPDATE `game_event_quest` SET `event`= 52 WHERE `quest`= 8828;
...
-- Adding to event 52 gameobjects

INSERT INTO `game_event_gameobject` (`guid`,`event`) VALUES (151761,52);
INSERT INTO `game_event_gameobject` (`guid`,`event`) VALUES (151762,52);
INSERT INTO `game_event_gameobject` (`guid`,`event`) VALUES (151763,52);
INSERT INTO `game_event_gameobject` (`guid`,`event`) VALUES (151764,52);
INSERT INTO `game_event_gameobject` (`guid`,`event`) VALUES (151765,52);
INSERT INTO `game_event_gameobject` (`guid`,`event`) VALUES (151766,52);
INSERT INTO `game_event_gameobject` (`guid`,`event`) VALUES (151767,52);
INSERT INTO `game_event_gameobject` (`guid`,`event`) VALUES (151768,52);
INSERT INTO `game_event_gameobject` (`guid`,`event`) VALUES (151769,52);
INSERT INTO `game_event_gameobject` (`guid`,`event`) VALUES (151770,52);
