...
UPDATE `creature_template` SET `MinLevel`= 59, `MaxLevel`= 60, `MinLevelHealth`= 5800, `MaxLevelHealth`= 6800, `MinMeleeDmg`= 118, `MaxMeleeDmg`= 125, `MeleeAttackPower`= 56, `RangedAttackPower`= 100, `EquipmentTemplateId`= 0, `AIName`= 'EventAI' WHERE `Entry` IN (17050, 17051);
