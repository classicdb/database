...
UPDATE `db_script_string` SET `content_default` = 'Where\'s the water, Emma? Get the water, Emma? If\'n it werent fer me, that lot wouldn\'t know what water looks like.' WHERE `entry` = 2000005104;
